...
# ------------------------------
# Logique de suivi des tags
# ------------------------------
last_seen = {}  # { tag_id: (antenne, timestamp) }
timeout = 5     # secondes max entre deux d  tections
    ...
    try:
        if "Tag RFID d  tect   par l'antenne" in payload:
            ...
            if tag_id in last_seen:
                ...
                if now - prev_time <= timeout and antenne != prev_antenne:
